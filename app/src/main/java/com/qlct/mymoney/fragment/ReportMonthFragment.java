...
public class ReportMonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        expenditus.add(new BarEntry(7, 5600000));
        expenditus.add(new BarEntry(8, 3000000));
        expenditus.add(new BarEntry(9, 8300000));
        expenditus.add(new BarEntry(10, 6000000));
        expenditus.add(new BarEntry(11, 4000000));
        expenditus.add(new BarEntry(12, 6000000));
        ArrayList<BarEntry> inditous = new ArrayList<>();
        inditous.add(new BarEntry(1.5f, 2000000));
        inditous.add(new BarEntry(2.5f, 4000000));
        inditous.add(new BarEntry(3.5f, 3000000));
        inditous.add(new BarEntry(4.5f, 3000000));
        inditous.add(new BarEntry(5.5f, 5000000));
        inditous.add(new BarEntry(6.5f, 6000000));
        inditous.add(new BarEntry(7.5f, 1000000));
        inditous.add(new BarEntry(8.5f, 3000000));
        inditous.add(new BarEntry(9.5f, 2000000));
        inditous.add(new BarEntry(10.5f, 3000000));
        inditous.add(new BarEntry(11.5f, 4000000));
        inditous.add(new BarEntry(12.5f, 3000000));
        ...
        pieChartOnes = view.findViewById(R.id.pieChart_month);
        ...
        pieChartTwos = view.findViewById(R.id.pieChart_month_one);
