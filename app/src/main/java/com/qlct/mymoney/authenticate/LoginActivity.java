...
import com.qlct.mymoney.base.BaseActivity;
import com.qlct.mymoney.base.ViewModelProviderFactory;
import com.qlct.mymoney.databinding.ActivityLoginBinding;
import com.qlct.mymoney.dialog.DialogManager;
import com.qlct.mymoney.dialog.LoadingDialogManager;
import com.qlct.mymoney.dialog.MessageDialog;
import com.qlct.mymoney.utils.Constants;
import com.qlct.mymoney.utils.NetworkUtils;
import com.qlct.mymoney.utils.PhoneNumberManager;
    ...
    private void StartFirebaseLogin() {
        ...
        mCallback = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                try {
                    Log.d("CODE", phoneAuthCredential.getSmsCode());
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
            ...
            public void onCodeSent(String vertificationId, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                Log.d("onCodeSent", "" + verificationCode);
                        ...
                        if (task.isSuccessful()) {
                            ...
                            user.getIdToken(true).addOnSuccessListener(new OnSuccessListener<GetTokenResult>() {
                                ...
                                public void onSuccess(GetTokenResult getTokenResult) {
                                    ...
                                    SharedPreferencesManager.getDefault(mLoginActivity).saveFireBaseToken(gToken);
...
//                                    }
                            ...
                            startActivity(new Intent(LoginActivity.this, PinPasswordActivity.class));
                            finish();
                        } else {
                            LoadingDialogManager.getDefault(mLoginActivity).hideDialog();
                            MessageDialog messageDialog = new MessageDialog(
